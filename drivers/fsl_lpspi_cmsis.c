...
//        xfer->configFlags = (uint32_t)kLPSPI_MasterPcs0 | (uint32_t)kLPSPI_MasterPcsContinuous;
        xfer->configFlags = (uint32_t)kLPSPI_MasterPcs0 | (uint32_t)kLPSPI_MasterPcsContinuous | (uint32_t)kLPSPI_MasterByteSwap;
...
static cmsis_lpspi_edma_resource_t LPSPI1_EdmaResource = {
    RTE_SPI1_DMA_TX_DMA_BASE,    RTE_SPI1_DMA_TX_CH,          30,//TODO//(uint16_t)RTE_SPI1_DMA_TX_PERI_SEL,
    RTE_SPI1_DMA_RX_DMA_BASE,    RTE_SPI1_DMA_RX_CH,          31,//TODO//(uint16_t)RTE_SPI1_DMA_RX_PERI_SEL,
#if (defined(FSL_FEATURE_SOC_DMAMUX_COUNT) && FSL_FEATURE_SOC_DMAMUX_COUNT)
...
static cmsis_lpspi_edma_resource_t LPSPI6_EdmaResource = {
    RTE_SPI6_DMA_TX_DMA_BASE,    RTE_SPI6_DMA_TX_CH,          kDma0RequestMuxLpFlexcomm6Tx,//(uint16_t)RTE_SPI6_DMA_TX_PERI_SEL,
    RTE_SPI6_DMA_RX_DMA_BASE,    RTE_SPI6_DMA_RX_CH,          kDma0RequestMuxLpFlexcomm6Rx,//(uint16_t)RTE_SPI6_DMA_RX_PERI_SEL,
#if (defined(FSL_FEATURE_SOC_DMAMUX_COUNT) && FSL_FEATURE_SOC_DMAMUX_COUNT)
...
static cmsis_lpspi_edma_resource_t LPSPI7_EdmaResource = {
    RTE_SPI7_DMA_TX_DMA_BASE,    RTE_SPI7_DMA_TX_CH,          kDma0RequestMuxLpFlexcomm7Tx,//(uint16_t)RTE_SPI7_DMA_TX_PERI_SEL,
    RTE_SPI7_DMA_RX_DMA_BASE,    RTE_SPI7_DMA_RX_CH,          kDma0RequestMuxLpFlexcomm7Rx,//(uint16_t)RTE_SPI7_DMA_RX_PERI_SEL,
#if (defined(FSL_FEATURE_SOC_DMAMUX_COUNT) && FSL_FEATURE_SOC_DMAMUX_COUNT)
